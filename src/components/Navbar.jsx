  ...
  return (
    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          <img src={logo} className="w-9 h-9 object-container" alt="Logo" />
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Vicente &nbsp;<span className='sm:block hidden'>| Full Stack Developer</span></p>
        </Link> 
